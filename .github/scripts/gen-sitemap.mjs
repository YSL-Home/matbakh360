...
console.log(`   recettes SPA:${recipeIds.length}  restos SPA:${restoIds.length}  recettes SEO:${seoRecipes.length}  localisées:${seoLangRec.length}  restos SEO:${seoRestos.length}  vidéos SEO:${seoVids.length}  hubs:${seoHubs.length}  statiques:${staticPages.length}`);
